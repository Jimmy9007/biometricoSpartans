    ...
    protected void process(DPFPSample sample) {
        ...
        for (JsonElement jsonElement : list) {
            ...
            if (resultado.isVerified()) {
                ...
                String rolId = jsonObject.get("fk_rol_id").getAsString();
                int numDias = Integer.parseInt(diasFaltantes);
                int numRol = Integer.parseInt(rolId);
                ...
                if (numDias >= 0 || numRol == 1 || numRol == 3 || numRol == 4) {
