...
public class CaptureForm
    ...
    protected void init() {
        capturer.addDataListener(new DPFPDataAdapter() {
            ...
            public void dataAcquired(final DPFPDataEvent e) {
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        makeReport("Se capturó la muestra de huellas dactilares.");
                        setPrompt("Escanee la misma huella digital nuevamente.");
                        process(e.getSample());
                    }
                });
            }
        ...
        capturer.addReaderStatusListener(new DPFPReaderStatusAdapter() {
            ...
            public void readerDisconnected(final DPFPReaderStatusEvent e) {
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        makeReport("Se desconectó el lector de huellas dactilares.");
                    }
                });
            }
        });
    ...
    protected void start() {
        ...
        setPrompt("Con el lector de huellas digitales, escanee su huella digital.");
    }
